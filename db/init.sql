...
CREATE TABLE Brand (
                       ...
                       websiteUrl VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL CHECK (TRIM(websiteUrl) IS NULL OR TRIM(websiteUrl) <> '')  ,
                       isActive BOOLEAN NOT NULL DEFAULT TRUE,
                       countryOfOrigin VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL CHECK (TRIM(countryOfOrigin) IS NULL OR TRIM(countryOfOrigin) <> ''),
