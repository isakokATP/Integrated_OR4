      ...
      >
        ...
        <div class="flex justify-between items-start mb-4">
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600">
              Payment Date:
              <span class="font-semibold text-gray-800">{{
                formatOrderDate(order.paymentDate)
              }}</span>
            </p>
            <p class="text-sm text-gray-600">
              Seller:
        ...
        <div class="space-y-3">
          ...
          >
            <!-- Item Image -->
            <div
              class="w-24 h-24 flex-shrink-0 bg-gray-200 rounded-lg overflow-hidden"
            >
              <img
                v-if="item.imageUrl"
            ...
            <div class="flex-1">
              ...
              <div class="mt-2 flex gap-4 text-sm text-gray-600">
                <span
                  >Quantity:
                  <span class="font-semibold">{{ item.quantity }}</span></span
                >
                <span
                  >Unit Price:
...
const getImageUrl = (filename) =>
  filename ? `/or4/uploads/${encodeURIComponent(filename)}` : null;
